...
/** South Korea plans-page hero copy. Country-specific; not used inside the reusable UI. */
export const southKoreaPlansHeroContent: CountryPlansHeroContent = {
...
/** South Korea how-to-choose guide. Country-specific; not used inside the reusable UI. */
export const southKoreaHowToChooseContent: HowToChooseEsimContent = {
  eyebrow: "Buying Guide",
  headingTemplate: "How to Choose an eSIM for {countryName}",
  intro:
    "The right plan depends on how long you will be in {countryName}, where you will travel and how you use your phone. A few days in Seoul has different needs from a KTX ride, a trip to Jeju, or a flight to Japan.",
  criteria: [
    {
    ...
    },
    {
      ...
      paragraphs: [
        "The mobile networks in {countryName} are SK Telecom, KT and LG U+. Other brands use one of these networks. In rural areas the three operators share parts of the network. International eSIM providers connect through one or more of these local partner networks.",
        "The local partner matters because coverage and performance vary by location. Check the network shown on each plan, especially if your route includes a KTX trip, indoor sites, or areas outside Seoul.",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        "Many travel eSIMs are data only. You can still use WhatsApp, FaceTime, Signal and other internet-based apps, but you may not receive a South Korean phone number or standard voice and SMS service.",
...
/** South Korea data-needs guide. Country-specific; not used inside the reusable UI. */
export const southKoreaDataNeedsContent: DataNeedsContent = {
  eyebrow: "Data Guide",
...
/** South Korea network coverage guide. Country-specific; not used inside the reusable UI. */
export const southKoreaNetworkCoverageContent: NetworkCoverageContent = {
  eyebrow: "Coverage",
  headingTemplate: "Mobile Networks and eSIM Coverage in {countryName}",
  paragraphs: [
    "The mobile networks in {countryName} are SK Telecom, KT and LG U+. Other brands use one of these networks, and in rural areas the three operators share parts of the network. In December 2025, the Ministry of Science and ICT checked 350 major facilities and found a 5G access rate of 97.69%. That figure is not coverage of the whole population. Weaker results were mainly indoors and on some high-speed rail lines. A travel eSIM only receives the networks and technologies in its provider agreement.",
    "Seoul, Busan and Incheon usually offer more network choice than smaller towns. Signal quality can still change inside buildings, on the subway and on a KTX train.",
  ...
  notice:
    "Jeju is part of {countryName}. A plan for {countryName} includes it when the provider's coverage does. North Korea is a separate country.",
};

/** South Korea unlimited-plans guide. Country-specific; not used inside the reusable UI. */
export const southKoreaUnlimitedPlansContent: UnlimitedPlansContent = {
...
/** South Korea eSIM vs local SIM guide. Country-specific; not used inside the reusable UI. */
export const southKoreaEsimVsLocalContent: EsimVsLocalContent = {
  eyebrow: "eSIM vs Local",
  headingTemplate: "eSIM or Local SIM in {countryName}?",
  intro:
    "Both can work well. The better choice depends on whether you value setup before arrival, a local phone number or access to a particular South Korean operator.",
  columns: {
  ...
  rows: [
    {
      ...
      localSim: "Often purchased from a South Korean operator shop or airport dealer",
    },
    {
    ...
    },
    {
      ...
      localSim: "May offer local bundles and a South Korean phone number",
    },
    {
    ...
    },
    {
      ...
      localSim:
        "KT can open a prepaid line with a passport for 90 days",
    },
  ],
  closingParagraphs: [
    "A travel eSIM is useful when you want data ready for arrival and do not need a South Korean number. A local plan may suit a longer stay or a traveler who needs conventional calls, SMS and local service. KT says a standard passport can open a prepaid line, and that passport-only service lasts 90 days from activation. A longer contract usually needs an Alien Registration Card. Compare the complete package rather than assuming one type is always cheaper.",
  ],
};

/** South Korea country vs regional Asia guide. Country-specific; not used inside the reusable UI. */
export const southKoreaCountryVsRegionalContent: CountryVsRegionalContent = {
  ...
  regionalOption: {
    ...
    paragraphs: [
      "A regional Asia eSIM can be more convenient if the same trip includes Japan or Taiwan. You can keep one eSIM profile active instead of installing a separate plan in each country.",
    ],
    destinations: ["Japan", "Taiwan"],
  },
  notice:
    "Always check the included destination list. A plan for {countryName} does not include Japan. North Korea is a separate country. China, Hong Kong and other Asian countries are included only when the provider names them. Also verify whether the same data allowance, speed policy and network access apply throughout the region.",
};

/** South Korea phone compatibility guide. Country-specific; not used inside the reusable UI. */
export const southKoreaPhoneCompatibilityContent: PhoneCompatibilityContent = {
...
/** South Korea traveler tips. Country-specific; not used inside the reusable UI. */
export const southKoreaTravelerTipsContent: TravelerTipsContent = {
  ...
  tips: [
    ...
    {
      title: "Save maps before a KTX trip.",
      paragraphs: [
        "The December 2025 check found weaker 5G on some high-speed rail lines. Download the route if you need it offline.",
      ],
    },
    {
      title: "Expect signal changes on the Seoul subway.",
      paragraphs: [
        "Coverage can change in subway stations. Download the route if you need it offline.",
      ],
    },
    {
      title: "Jeju is part of {countryName}.",
      paragraphs: [
        "A plan for {countryName} includes Jeju when the provider's coverage does. Confirm the route before you fly there.",
      ],
    },
    {
      title: "Japan needs its own listing.",
      paragraphs: [
        "A flight or ferry to Japan is a new country. Japan has to be named on the plan if you want data there too.",
      ],
    },
  ],
};

/** South Korea FAQs. Country-specific; not used inside the reusable UI. */
export const southKoreaFaqsContent: CountryFaqsContent = {
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "The mobile networks in {countryName} are SK Telecom, KT and LG U+. Other brands use one of these networks rather than running a fourth national network. In rural areas the three operators share parts of the network. Check the partner named on the plan, because coverage and 5G access change by location and device, including on some high-speed rail lines.",
    },
    {
      question: "Does {countryName} have 5G coverage?",
      answer:
        "Yes. SK Telecom, KT and LG U+ operate 5G. In the Ministry of Science and ICT's December 2025 check of 350 major facilities, the 5G access rate was 97.69%. That figure is not coverage of the whole population. Weaker spots were mainly indoors and on some high-speed rail lines. A 5G phone does not guarantee that a travel eSIM will connect to 5G. The plan must include 5G access, the partner must offer it where you are, and your device must support the bands. Otherwise the connection uses 4G.",
    },
    {
      question: "Does an eSIM for {countryName} work in Japan?",
      answer:
        "A plan for {countryName} stops at the border. It does not automatically include Japan or Taiwan. Jeju is part of {countryName}, so it is included when the provider's coverage includes it. North Korea is a separate country. Check the list before a flight or ferry onward.",
    },
    {
      question: "Do I need a passport to buy a local SIM in {countryName}?",
      answer:
        "Yes, for a short prepaid line from KT. KT says a standard passport can open that prepaid line, and passport-only service lasts 90 days from activation. A longer contract usually needs an Alien Registration Card, and other operators set their own checks. An international travel eSIM follows that provider's own checks, which can be different.",
    },
    {
