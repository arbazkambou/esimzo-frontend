...
/** Vietnam plans-page hero copy. Country-specific; not used inside the reusable UI. */
export const vietnamPlansHeroContent: CountryPlansHeroContent = {
...
/** Vietnam how-to-choose guide. Country-specific; not used inside the reusable UI. */
export const vietnamHowToChooseContent: HowToChooseEsimContent = {
  eyebrow: "Buying Guide",
  headingTemplate: "How to Choose an eSIM for {countryName}",
  intro:
    "The right plan depends on how long you will be in {countryName}, where you will travel and how you use your phone. A few days in Hanoi or Ho Chi Minh City has different needs from a mountain road in the north, the Mekong Delta, or a crossing into Cambodia or Laos.",
  criteria: [
    {
    ...
    },
    {
      ...
      paragraphs: [
        "The main mobile networks in {countryName} are Viettel, Vinaphone and MobiFone. Vinaphone is the mobile brand of VNPT. International eSIM providers connect through one or more of these local partner networks.",
        "The local partner matters because coverage and performance vary by location. Check the network shown on each plan, especially if your route leaves the big cities or includes a mountain road, the Mekong Delta, or Phu Quoc.",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        "Many travel eSIMs are data only. You can still use WhatsApp, FaceTime, Signal and other internet-based apps, but you may not receive a Vietnamese phone number or standard voice and SMS service.",
...
/** Vietnam data-needs guide. Country-specific; not used inside the reusable UI. */
export const vietnamDataNeedsContent: DataNeedsContent = {
  eyebrow: "Data Guide",
...
/** Vietnam network coverage guide. Country-specific; not used inside the reusable UI. */
export const vietnamNetworkCoverageContent: NetworkCoverageContent = {
  eyebrow: "Coverage",
  headingTemplate: "Mobile Networks and eSIM Coverage in {countryName}",
  paragraphs: [
    "The main mobile networks in {countryName} are Viettel, Vinaphone and MobiFone. Vinaphone is the mobile brand of VNPT. The Ministry of Science and Technology reports that 5G coverage rose from 0.93% of the population in 2023 to 90.2% in 2025. That figure is not the coverage of each partner. Viettel reported about 90% outdoor coverage by the end of 2025. Vinaphone and MobiFone have focused on cities and transport hubs. A travel eSIM only receives the networks and technologies in its provider agreement.",
    "Hanoi, Ho Chi Minh City and Da Nang usually offer more network choice than smaller towns and open country. Signal quality can still change inside buildings, on the metro, on mountain roads and in the Mekong Delta.",
  ...
  notice:
    "Phu Quoc is part of {countryName}. A plan for {countryName} includes it when the provider's coverage does. Cambodia and Laos are separate countries.",
};

/** Vietnam unlimited-plans guide. Country-specific; not used inside the reusable UI. */
export const vietnamUnlimitedPlansContent: UnlimitedPlansContent = {
...
/** Vietnam eSIM vs local SIM guide. Country-specific; not used inside the reusable UI. */
export const vietnamEsimVsLocalContent: EsimVsLocalContent = {
  eyebrow: "eSIM vs Local",
  headingTemplate: "eSIM or Local SIM in {countryName}?",
  intro:
    "Both can work well. The better choice depends on whether you value setup before arrival, a local phone number or access to a particular Vietnamese operator.",
  columns: {
  ...
  rows: [
    {
      ...
      localSim: "Often purchased from a Vietnamese operator shop or airport dealer",
    },
    {
    ...
    },
    {
      ...
      localSim: "May offer local bundles and a Vietnamese phone number",
    },
    {
    ...
    },
    {
      ...
      localSim:
        "A foreign visitor registers a local line with a valid passport",
    },
  ],
  closingParagraphs: [
    "A travel eSIM is useful when you want data ready for arrival and do not need a Vietnamese number. A local plan may suit a longer stay or a traveler who needs conventional calls, SMS and local service. A foreign visitor registers that line with a valid passport that covers the visa or the visa-exempt stay, or with an electronic identification account. Compare the complete package rather than assuming one type is always cheaper.",
  ],
};

/** Vietnam country vs regional Asia guide. Country-specific; not used inside the reusable UI. */
export const vietnamCountryVsRegionalContent: CountryVsRegionalContent = {
  ...
  regionalOption: {
    ...
    paragraphs: [
      "A regional Asia eSIM can be more convenient if the same trip includes Cambodia or Laos. You can keep one eSIM profile active while crossing those borders instead of installing a separate plan in each country.",
    ],
    destinations: ["Cambodia", "Laos"],
  },
  notice:
    "Always check the included destination list. A plan for {countryName} stops at the border. Thailand and China are included only when the provider names them. Also verify whether the same data allowance, speed policy and network access apply throughout the region.",
};

/** Vietnam phone compatibility guide. Country-specific; not used inside the reusable UI. */
export const vietnamPhoneCompatibilityContent: PhoneCompatibilityContent = {
...
/** Vietnam traveler tips. Country-specific; not used inside the reusable UI. */
export const vietnamTravelerTipsContent: TravelerTipsContent = {
  ...
  tips: [
    ...
    {
      title: "Download maps before a mountain road or the Mekong Delta.",
      paragraphs: [
        "Signal can thin out on mountain roads in the north and away from towns in the delta. Save maps before you leave a city.",
      ],
    },
    {
      title: "Expect signal changes on the metro.",
      paragraphs: [
        "Coverage can change in metro stations in Hanoi and Ho Chi Minh City. Download the route if you need it offline.",
      ],
    },
    {
      title: "Phu Quoc is part of {countryName}.",
      paragraphs: [
        "A plan for {countryName} includes Phu Quoc when the provider's coverage does. Confirm the route before you fly there.",
      ],
    },
    {
      title: "Cambodia or Laos needs its own listing.",
      paragraphs: [
        "A crossing is a new country. Cambodia and Laos have to be named on the plan if you want data there too.",
      ],
    },
  ],
};

/** Vietnam FAQs. Country-specific; not used inside the reusable UI. */
export const vietnamFaqsContent: CountryFaqsContent = {
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "The main mobile networks in {countryName} are Viettel, Vinaphone and MobiFone. Vinaphone is the mobile brand of VNPT. Travel eSIM providers use agreements with one or more of these networks. Check the partner named on the plan, because 5G coverage is not the same on every network, especially outside the largest cities.",
    },
    {
      question: "Does {countryName} have 5G coverage?",
      answer:
        "Yes. The Ministry of Science and Technology reports 5G coverage for 90.2% of the population in 2025, up from 0.93% in 2023. That is not the coverage of each partner. Viettel reported about 90% outdoor coverage. Vinaphone and MobiFone have focused on cities and transport hubs. A 5G phone does not guarantee that a travel eSIM will connect to 5G. The plan must include 5G access, the partner must offer it where you are, and your device must support the bands. Otherwise the connection uses 4G.",
    },
    {
      question: "Does an eSIM for {countryName} work in Cambodia?",
      answer:
        "A plan for {countryName} stops at the border. It does not automatically include Cambodia, Laos, Thailand or China. Phu Quoc is part of {countryName}, so it is included when the provider's coverage includes it. Check the list before a crossing or a flight onward.",
    },
    {
      question: "Do I need a passport to buy a local SIM in {countryName}?",
      answer:
        "Yes, if you buy a local mobile line as a foreign visitor. You register with a valid passport that covers the visa or the visa-exempt stay, or with an electronic identification account. The operator records the name, date of birth and passport number. An international travel eSIM follows that provider's own checks, which can be different.",
    },
    {
