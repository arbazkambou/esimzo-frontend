...
/** India plans-page hero copy. Country-specific; not used inside the reusable UI. */
export const indiaPlansHeroContent: CountryPlansHeroContent = {
...
/** India how-to-choose guide. Country-specific; not used inside the reusable UI. */
export const indiaHowToChooseContent: HowToChooseEsimContent = {
  eyebrow: "Buying Guide",
  headingTemplate: "How to Choose an eSIM for {countryName}",
  intro:
    "The right plan depends on how long you will be in {countryName}, where you will travel and how you use your phone. A few days in Delhi or Mumbai has different needs from a Himalayan road, a trip to Goa, or a crossing into Nepal.",
  criteria: [
    {
    ...
    },
    {
      ...
      paragraphs: [
        "The main mobile networks in {countryName} are Jio, Airtel and Vi. Vi is Vodafone Idea. BSNL is the state-owned operator. International eSIM providers connect through one or more of these local partner networks.",
        "The local partner matters because coverage and performance vary by location. Check the network shown on each plan, especially if your route leaves the big cities or includes a Himalayan road or a rural stretch.",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        "Many travel eSIMs are data only. You can still use WhatsApp, FaceTime, Signal and other internet-based apps, but you may not receive an Indian phone number or standard voice and SMS service.",
...
/** India data-needs guide. Country-specific; not used inside the reusable UI. */
export const indiaDataNeedsContent: DataNeedsContent = {
  eyebrow: "Data Guide",
...
/** India network coverage guide. Country-specific; not used inside the reusable UI. */
export const indiaNetworkCoverageContent: NetworkCoverageContent = {
  eyebrow: "Coverage",
  headingTemplate: "Mobile Networks and eSIM Coverage in {countryName}",
  paragraphs: [
    "The main mobile networks in {countryName} are Jio, Airtel and Vi. Vi is Vodafone Idea, and BSNL is the state-owned operator. The Department of Telecommunications reports 5G in every state and union territory, in 99.9% of districts, with population coverage of 85% as of 31 October 2025. That figure is not the coverage of each partner. A travel eSIM only receives the networks and technologies in its provider agreement.",
    "Delhi, Mumbai and Bengaluru usually offer more network choice than hill towns and rural areas. Signal quality can still change inside buildings, on the metro and on mountain roads.",
  ...
  notice:
    "The Andaman and Nicobar Islands and Lakshadweep are part of {countryName}. A plan for {countryName} includes them when the provider's coverage does. Nepal and Sri Lanka are separate countries.",
};

/** India unlimited-plans guide. Country-specific; not used inside the reusable UI. */
export const indiaUnlimitedPlansContent: UnlimitedPlansContent = {
...
/** India eSIM vs local SIM guide. Country-specific; not used inside the reusable UI. */
export const indiaEsimVsLocalContent: EsimVsLocalContent = {
  eyebrow: "eSIM vs Local",
  headingTemplate: "eSIM or Local SIM in {countryName}?",
  intro:
    "Both can work well. The better choice depends on whether you value setup before arrival, a local phone number or access to a particular Indian operator.",
  columns: {
  ...
  rows: [
    {
      ...
      localSim: "Often purchased from an Indian operator shop or airport dealer",
    },
    {
    ...
    },
    {
      ...
      localSim: "May offer local bundles and an Indian phone number",
    },
    {
    ...
    },
    {
      ...
      localSim:
        "A foreign visitor registers a local line with a passport and visa",
    },
  ],
  closingParagraphs: [
    "A travel eSIM is useful when you want data ready for arrival and do not need an Indian number. A local plan may suit a longer stay or a traveler who needs conventional calls, SMS and local service. A foreign visitor registers that line with a passport and a valid visa, plus the address of the stay or a local reference. A tourist connection should not last beyond the visa, and not more than three months at a time. Compare the complete package rather than assuming one type is always cheaper.",
  ],
};

/** India country vs regional Asia guide. Country-specific; not used inside the reusable UI. */
export const indiaCountryVsRegionalContent: CountryVsRegionalContent = {
  ...
  regionalOption: {
    ...
    paragraphs: [
      "A regional Asia eSIM can be more convenient if the same trip includes Nepal or Sri Lanka. You can keep one eSIM profile active across those destinations instead of installing a separate plan in each country.",
    ],
    destinations: ["Nepal", "Sri Lanka"],
  },
  notice:
    "Always check the included destination list. A plan for {countryName} does not include Nepal. Bangladesh, Bhutan, the Maldives and Pakistan are included only when the provider names them. Also verify whether the same data allowance, speed policy and network access apply throughout the region.",
};

/** India phone compatibility guide. Country-specific; not used inside the reusable UI. */
export const indiaPhoneCompatibilityContent: PhoneCompatibilityContent = {
...
/** India traveler tips. Country-specific; not used inside the reusable UI. */
export const indiaTravelerTipsContent: TravelerTipsContent = {
  ...
  tips: [
    ...
    {
      title: "Download maps before a Himalayan road.",
      paragraphs: [
        "Signal can thin out on mountain roads and away from towns. Save maps before you leave a city.",
      ],
    },
    {
      title: "Expect signal changes on city trains.",
      paragraphs: [
        "Coverage can change on the Delhi Metro and on Mumbai local trains. Download the route if you need it offline.",
      ],
    },
    {
      title: "The island groups are part of {countryName}.",
      paragraphs: [
        "The Andaman and Nicobar Islands and Lakshadweep are part of {countryName}. Confirm the provider's coverage before you fly there.",
      ],
    },
    {
      title: "Nepal needs its own listing.",
      paragraphs: [
        "A crossing into Nepal is a new country. Nepal has to be named on the plan if you want data there too.",
      ],
    },
  ],
};

/** India FAQs. Country-specific; not used inside the reusable UI. */
export const indiaFaqsContent: CountryFaqsContent = {
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "The main mobile networks in {countryName} are Jio, Airtel and Vi. Vi is Vodafone Idea. BSNL is the state-owned operator. Travel eSIM providers use agreements with one or more of these networks. Check the partner named on the plan, because the national 5G figure is not the coverage of each partner, especially outside the largest cities.",
    },
    {
      question: "Does {countryName} have 5G coverage?",
      answer:
        "Yes, for most of the population. The Department of Telecommunications reports 5G in every state and union territory, in 99.9% of districts, with population coverage of 85% as of 31 October 2025. That figure is not the coverage of each partner. A 5G phone does not guarantee that a travel eSIM will connect to 5G. The plan must include 5G access, the partner must offer it where you are, and your device must support the bands. Otherwise the connection uses 4G.",
    },
    {
      question: "Does an eSIM for {countryName} work in Nepal?",
      answer:
        "A plan for {countryName} stops at the border. It does not automatically include Nepal, Sri Lanka or Bangladesh. The Andaman and Nicobar Islands and Lakshadweep are part of {countryName}, so they are included when the provider's coverage includes them. Check the list before a crossing or a flight onward.",
    },
    {
      question: "Do I need a passport to buy a local SIM in {countryName}?",
      answer:
        "Yes, if you buy a local line as a foreign visitor. The Department of Telecommunications treats a passport with a valid visa as proof of identity, plus the address of your stay or a local reference. A tourist connection should not last beyond the visa, and not more than three months at a time. An international travel eSIM follows that provider's own checks, which can be different.",
    },
    {
