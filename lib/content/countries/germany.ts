...
/** Germany plans-page hero copy. Country-specific; not used inside the reusable UI. */
export const germanyPlansHeroContent: CountryPlansHeroContent = {
...
/** Germany how-to-choose guide. Country-specific; not used inside the reusable UI. */
export const germanyHowToChooseContent: HowToChooseEsimContent = {
  eyebrow: "Buying Guide",
  headingTemplate: "How to Choose an eSIM for {countryName}",
  intro:
    "The right plan depends on how long you will be in {countryName}, where you will travel and how you use your phone. A few days in Berlin or Munich has different needs from a rail route across the country, a trip into the Bavarian Alps, or a crossing into France, the Netherlands, Austria or Czechia.",
  criteria: [
    {
    ...
    },
    {
      ...
      paragraphs: [
        "The public mobile networks in {countryName} are Telekom, Vodafone, O2 and 1&1. O2 is the consumer brand of Telefónica. 1&1 has operated its own network since December 2023, and that network is still being built. International eSIM providers connect through one or more of these local partner networks.",
        "The local partner matters because coverage and performance vary by location. Check the network shown on each plan, especially if your route leaves the big cities or includes the Bavarian Alps, a rural road, or the North Sea or Baltic coast.",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        "Many travel eSIMs are data only. You can still use WhatsApp, FaceTime, Signal and other internet-based apps, but you may not receive a German phone number or standard voice and SMS service.",
...
/** Germany data-needs guide. Country-specific; not used inside the reusable UI. */
export const germanyDataNeedsContent: DataNeedsContent = {
  eyebrow: "Data Guide",
...
/** Germany network coverage guide. Country-specific; not used inside the reusable UI. */
export const germanyNetworkCoverageContent: NetworkCoverageContent = {
  eyebrow: "Coverage",
  headingTemplate: "Mobile Networks and eSIM Coverage in {countryName}",
  paragraphs: [
    "The public mobile networks in {countryName} are Telekom, Vodafone, O2 and 1&1. O2 is the consumer brand of Telefónica. 1&1 has operated its own network since December 2023, and that network is still being built, so its own footprint can be narrower than the other three. The Bundesnetzagentur says the 5G rollout is not finished. Coverage varies by operator, and rural areas are more often still on 4G. A travel eSIM only receives the networks and technologies in its provider agreement.",
    "Berlin, Munich, Hamburg, Cologne and Frankfurt usually offer more network choice than smaller towns and open country. Signal quality can still change inside buildings, on the U-Bahn, in rail tunnels, in the Bavarian Alps and in forests.",
  ...
  networks: ["Telekom", "Vodafone", "O2", "1&1"],
  notice:
    "The North Sea and Baltic islands, including Sylt and Rügen, are part of {countryName}. A plan for {countryName} includes them when the provider's coverage does. Signal can still be weaker on a smaller island or along an open coast.",
};

/** Germany unlimited-plans guide. Country-specific; not used inside the reusable UI. */
export const germanyUnlimitedPlansContent: UnlimitedPlansContent = {
...
/** Germany eSIM vs local SIM guide. Country-specific; not used inside the reusable UI. */
export const germanyEsimVsLocalContent: EsimVsLocalContent = {
  eyebrow: "eSIM vs Local",
  headingTemplate: "eSIM or Local SIM in {countryName}?",
  intro:
    "Both can work well. The better choice depends on whether you value setup before arrival, a local phone number or access to a particular German operator.",
  columns: {
  ...
  rows: [
    {
      ...
      localSim: "Often purchased directly from a German operator or retailer",
    },
    {
    ...
    },
    {
      ...
      localSim: "May offer local bundles and a German phone number",
    },
    {
    ...
    },
    {
      ...
      localSim:
        "A prepaid line is checked against a passport or other official photo identity document before activation",
    },
  ],
  closingParagraphs: [
    "A travel eSIM is useful when you want data ready for arrival and do not need a German number. A local plan may suit a longer stay or a traveler who needs conventional calls, SMS and local service. A German prepaid line stays inactive until the provider has checked identity. Compare the complete package rather than assuming one type is always cheaper.",
  ],
};

/** Germany country vs regional Europe guide. Country-specific; not used inside the reusable UI. */
export const germanyCountryVsRegionalContent: CountryVsRegionalContent = {
  ...
  regionalOption: {
    ...
    paragraphs: [
      "A regional Europe eSIM can be more convenient if the same trip includes France, the Netherlands, Austria or Czechia. You can keep one eSIM profile active while crossing those borders instead of installing a separate plan in each country.",
    ],
    destinations: ["France", "Netherlands", "Austria", "Czechia"],
  },
  notice:
    "Always check the included destination list. Switzerland is not in the European Union, so a plan marketed for Europe includes it only when the provider names it. Poland and Denmark are also neighbors. A plan for {countryName} includes those countries only when they are named. Also verify whether the same data allowance, speed policy and network access apply throughout the region.",
};

/** Germany phone compatibility guide. Country-specific; not used inside the reusable UI. */
export const germanyPhoneCompatibilityContent: PhoneCompatibilityContent = {
...
/** Germany traveler tips. Country-specific; not used inside the reusable UI. */
export const germanyTravelerTipsContent: TravelerTipsContent = {
  ...
  tips: [
    ...
    {
      title: "Download maps before the Bavarian Alps or a rural road.",
      paragraphs: [
        "Signal can thin out in the Bavarian Alps, in forests and on rural roads. Save maps and tickets before you leave a city.",
      ],
    },
    {
      title: "Expect signal changes on the U-Bahn and on long-distance trains.",
      paragraphs: [
        "Coverage can change in metro stations and in rail tunnels. Download the route before a long ride if you need it offline.",
      ],
    },
    {
      title: "North Sea and Baltic islands are part of {countryName}.",
      paragraphs: [
        "Sylt, Rügen and the other islands are part of {countryName}. A plan covers them when the provider's coverage does. Check before a ferry if the coast is on your route.",
      ],
    },
    {
      title: "A border crossing needs its own listing.",
      paragraphs: [
        "Data for {countryName} stops at the border. France, the Netherlands, Austria, Czechia, Poland, Denmark and Switzerland have to be named if you want data there too.",
      ],
    },
  ],
};

/** Germany FAQs. Country-specific; not used inside the reusable UI. */
export const germanyFaqsContent: CountryFaqsContent = {
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "The public mobile networks in {countryName} are Telekom, Vodafone, O2 and 1&1. O2 is the consumer brand of Telefónica. 1&1 has operated its own network since December 2023, and that network is still being built. Other brands resell one of these networks. Check the partner named on the plan, because coverage and 5G access change by location and device, especially outside the largest cities.",
    },
    {
      question: "Does {countryName} have 5G coverage?",
      answer:
        "Yes, with gaps. The Bundesnetzagentur says the 5G rollout is not finished, coverage varies by operator, and rural areas are more often still on 4G. A 5G phone does not guarantee that a travel eSIM will connect to 5G. The plan must include 5G access, the partner must offer it where you are, and your device must support the bands. 1&1 has operated its own network since December 2023, and that network is still being built, so its own footprint can be narrower than Telekom, Vodafone or O2. Otherwise the connection uses 4G.",
    },
    {
      question: "Does an eSIM for {countryName} work in neighboring countries?",
      answer:
        "A plan for {countryName} stops at the border. It does not automatically include France, the Netherlands, Austria, Czechia, Poland, Denmark or Switzerland. Switzerland is not in the European Union, so a plan sold as a Europe eSIM includes Switzerland only when the provider names it. Check the coverage list before you cross.",
    },
    {
      question: "Do I need a passport to buy a local SIM in {countryName}?",
      answer:
        "Yes, if you buy a prepaid line from a German provider. Before that line is activated, the provider must check a passport, a national identity card, or another official photo identity document. An international travel eSIM follows that provider's own checks, which can be different. The identity step applies to the German prepaid line, not automatically to every travel plan bought abroad.",
    },
    {
