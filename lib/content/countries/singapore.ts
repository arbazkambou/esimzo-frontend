...
/** Singapore plans-page hero copy. Country-specific; not used inside the reusable UI. */
export const singaporePlansHeroContent: CountryPlansHeroContent = {
...
/** Singapore how-to-choose guide. Country-specific; not used inside the reusable UI. */
export const singaporeHowToChooseContent: HowToChooseEsimContent = {
  eyebrow: "Buying Guide",
  headingTemplate: "How to Choose an eSIM for {countryName}",
  intro:
    "The right plan depends on how long you will be in {countryName}, where you will travel and how you use your phone. A few days in the city has different needs from a trip to Sentosa, a ferry to a smaller island, or a crossing into Malaysia.",
  criteria: [
    {
    ...
    },
    {
      ...
      paragraphs: [
        "The mobile networks in {countryName} are Singtel, StarHub, M1 and SIMBA. M1 and SIMBA are still separate networks. Other brands resell one of these networks. International eSIM providers connect through one or more of these local partner networks.",
        "The local partner matters because coverage and performance vary by location. Check the network shown on each plan, especially if your route includes the MRT, a basement mall, or a ferry to a smaller island.",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        "Many travel eSIMs are data only. You can still use WhatsApp, FaceTime, Signal and other internet-based apps, but you may not receive a Singaporean phone number or standard voice and SMS service.",
...
/** Singapore data-needs guide. Country-specific; not used inside the reusable UI. */
export const singaporeDataNeedsContent: DataNeedsContent = {
  eyebrow: "Data Guide",
...
/** Singapore network coverage guide. Country-specific; not used inside the reusable UI. */
export const singaporeNetworkCoverageContent: NetworkCoverageContent = {
  eyebrow: "Coverage",
  headingTemplate: "Mobile Networks and eSIM Coverage in {countryName}",
  paragraphs: [
    "The mobile networks in {countryName} are Singtel, StarHub, M1 and SIMBA. M1 and SIMBA are still separate networks. IMDA has said the operators have nationwide 5G standalone coverage. That does not mean every basement, MRT tunnel or ferry has the same signal. A travel eSIM only receives the networks and technologies in its provider agreement.",
    "The city centre usually offers more network choice than a smaller island or a sea crossing. Signal quality can still change inside buildings, in basement malls and on the MRT.",
  ...
  networks: ["Singtel", "StarHub", "M1", "SIMBA"],
  notice:
    "Sentosa and the other islands are part of {countryName}. A plan for {countryName} includes them when the provider's coverage does. A crossing into Malaysia, including over the Causeway, is a different country.",
};

/** Singapore unlimited-plans guide. Country-specific; not used inside the reusable UI. */
export const singaporeUnlimitedPlansContent: UnlimitedPlansContent = {
...
/** Singapore eSIM vs local SIM guide. Country-specific; not used inside the reusable UI. */
export const singaporeEsimVsLocalContent: EsimVsLocalContent = {
  eyebrow: "eSIM vs Local",
  headingTemplate: "eSIM or Local SIM in {countryName}?",
  intro:
    "Both can work well. The better choice depends on whether you value setup before arrival, a local phone number or access to a particular Singaporean operator.",
  columns: {
  ...
  rows: [
    {
      ...
      localSim:
        "Often purchased from a Singaporean operator shop or airport retailer",
    },
    {
    ...
    },
    {
      ...
      localSim: "May offer local bundles and a Singaporean phone number",
    },
    {
    ...
    },
    {
      ...
      localSim: "A visitor registers a prepaid line with a passport",
    },
  ],
  closingParagraphs: [
    "A travel eSIM is useful when you want data ready for arrival and do not need a Singaporean number. A local plan may suit a longer stay or a traveler who needs conventional calls, SMS and local service. IMDA requires registration for a prepaid line. A passport registration is valid for 30 days, including the day you register, and a person may hold up to three prepaid SIMs in total. Compare the complete package rather than assuming one type is always cheaper.",
  ],
};

/** Singapore country vs regional Asia guide. Country-specific; not used inside the reusable UI. */
export const singaporeCountryVsRegionalContent: CountryVsRegionalContent = {
  ...
  regionalOption: {
    ...
    paragraphs: [
      "A regional Asia eSIM can be more convenient if the same trip includes Malaysia or Indonesia. You can keep one eSIM profile active while crossing those borders instead of installing a separate plan in each country.",
    ],
    destinations: ["Malaysia", "Indonesia"],
  },
  notice:
    "Always check the included destination list. A plan for {countryName} stops at the Causeway and at the sea border. Thailand and other Asian countries are included only when the provider names them. Also verify whether the same data allowance, speed policy and network access apply throughout the region.",
};

/** Singapore phone compatibility guide. Country-specific; not used inside the reusable UI. */
export const singaporePhoneCompatibilityContent: PhoneCompatibilityContent = {
...
/** Singapore traveler tips. Country-specific; not used inside the reusable UI. */
export const singaporeTravelerTipsContent: TravelerTipsContent = {
  ...
  tips: [
    ...
    {
      title: "Download the route before a long MRT ride.",
      paragraphs: [
        "Coverage can change in MRT stations and tunnels. Save the route if you need it offline.",
      ],
    },
    {
      title: "Sentosa and the other islands are part of {countryName}.",
      paragraphs: [
        "A plan for {countryName} includes Sentosa and the other islands when the provider's coverage does. Check before a ferry to a smaller island.",
      ],
    },
    {
      title: "The Causeway is a border.",
      paragraphs: [
        "Data for {countryName} stops when you cross into Johor Bahru. Malaysia has to be named on the plan if you want data there.",
      ],
    },
    {
      title: "A ferry to Indonesia needs its own listing.",
      paragraphs: [
        "Indonesia is not included in a plan for {countryName} unless the provider names it. Check before a boat to Batam or Bintan.",
      ],
    },
  ],
};

/** Singapore FAQs. Country-specific; not used inside the reusable UI. */
export const singaporeFaqsContent: CountryFaqsContent = {
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "The mobile networks in {countryName} are Singtel, StarHub, M1 and SIMBA. M1 and SIMBA are still separate networks. Other brands resell one of these networks. Travel eSIM providers use agreements with one or more of them. Check the partner named on the plan, because coverage and 5G access can change in the MRT and inside buildings.",
    },
    {
      question: "Does {countryName} have 5G coverage?",
      answer:
        "Yes. Singtel, StarHub, M1 and SIMBA offer 5G, and IMDA has said the operators have nationwide 5G standalone coverage. That does not mean every basement or MRT tunnel has the same signal. A 5G phone does not guarantee that a travel eSIM will connect to 5G. The plan must include 5G access, the partner must offer it where you are, and your device must support the bands. Otherwise the connection uses 4G.",
    },
    {
      question: "Does an eSIM for {countryName} work in Malaysia?",
      answer:
        "A plan for {countryName} stops at the border. It does not automatically include Malaysia or Indonesia. Sentosa and the other islands are part of {countryName}, so they are included when the provider's coverage includes them. Check the list before you cross the Causeway or take a ferry.",
    },
    {
      question: "Do I need a passport to buy a local SIM in {countryName}?",
      answer:
        "Yes, if you buy a prepaid line from a Singaporean provider. IMDA requires registration, and a visitor uses a passport. A passport registration is valid for 30 days, including the day you register. A person may hold up to three prepaid SIMs in total, across all providers. An international travel eSIM follows that provider's own checks, which can be different.",
    },
    {
